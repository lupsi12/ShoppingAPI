...
import {deleteData, fetchData} from "../api/FetchAPI";
...
const Deneme = () => {
    ...
    useEffect(() => {
        const fetchPersonelData = async () => {
            try {
                const url = 'http://localhost:5250/api/personel'; // Örnek bir API URL'i
    ...
    const handleDelete = async (id) => {
        try {
            const url = 'http://localhost:5250/api/personel'; // Sample API URL
    ...
    return (
        <Layout>
            <div className="homeContainer">
                ...
                <p>Bu bir <code>kod parçası</code> içerir.</p>
            </div>
        </Layout>
    );
};
